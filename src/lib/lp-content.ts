export const LP_CONTENT = {
  ...
  plans: [
    {
      name: "STARTER PLAN", nameJp: "お試し導入に",
      price: "¥45,000", period: "/月（税込）",
      initFee: null as string | null,
      hours: "月12時間", minTerm: "1ヶ月〜", slots: "月3社限定", unitPrice: "¥3,750/時間",
      popular: false,
      features: ["経理・請求メイン対応", "専任担当者1名", "チャットサポート", "業務報告（週次）"],
    },
    {
      name: "STANDARD PLAN", nameJp: "本格的な右腕として",
      price: "¥80,000", period: "/月（税込）",
      initFee: "初期費用 ¥50,000→¥30,000" as string | null,
      hours: "月25時間", minTerm: "3ヶ月〜", slots: "月5社限定", unitPrice: "¥3,200/時間",
      popular: true,
